...
from phong import TfidfRetriever
...
def evaluate_tfidf(retriever: TfidfRetriever, qrels_files: Iterable[str], queries_path: str, predict_out: str, tf_scheme: str = "log"):
...
def main():
	...
	parser.add_argument("--predict-out", default="phong/evaluate/results/predict_tfidf.jsonl")
	parser.add_argument("--metrics-out", default="phong/evaluate/results/metrics_tfidf.json")
	...
	agg = evaluate_tfidf(retriever, args.qrels, args.queries, args.predict_out, tf_scheme=args.tf_scheme)
